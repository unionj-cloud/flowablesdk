...
const (
	...
	evaluateConditionsUrl = detailUrl + "/evaluate-conditions"
)
...
var (
	...
	EvaluateConditionsApi = flowablesdk.NewApi(httpclient.POST, evaluateConditionsUrl, flowablesdk.ProcessPrefix)
)
